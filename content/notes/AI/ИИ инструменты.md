...
- https://artificialanalysis.ai/leaderboards/models?utm_source=chatgpt.com
...
**Приложения**
- [ollama](https://ollama.com/) — приложение для запуска LLM на десктопном компьютере
- [pinokio]( https://pinokio.computer/) — приложение для запуска LLM и других нейросеток на десктопном компьютере
